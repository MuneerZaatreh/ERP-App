...
public class header extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView hamborgermenu = view.findViewById(R.id.menuhamborger);
        hamborgermenu.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ImageView myButton = view.findViewById(R.id.btn_logout);
